		...
		<div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-3 thumbnails_col order-lg-1 order-2">
                            <div class="single_product_thumbnails">
                                <ul>
                                    <li><img src="{{ asset($produk->gambar1) }}" alt="" data-image="{{ asset($produk->gambar1) }}"></li>
                                    <li><img src="{{ asset($produk->gambar2) }}" alt="" data-image="{{ asset($produk->gambar2) }}"></li>
                                    <li><img src="{{ asset($produk->gambar3) }}" alt="" data-image="{{ asset($produk->gambar3) }}"></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-9 image_col order-lg-2 order-1">
                            <div class="single_product_image">
                                ...
                                <div class="single_product_image_background" style="background-image:url({{ asset($produk->gambar1) }})"></div>
                            </div>
                        </div>
                    </div>
                </div>
			...
			<div class="col-lg-5">
				<div class="product_details">
					...
					<div class="original_price">${{ $produk->harga }}</div>
					...
					<div id="tab_1" class="tab_container active">
						<div class="row">
							<div class="col-lg-5 desc_col">
								...
								<div class="tab_image">
									<img src="{{asset ($produk->gambar1)}}" alt="">
								</div>

							</div>
							<div class="col-lg-5 offset-lg-2 desc_col">
								<div class="tab_image">
									<img src="{{asset ($produk->gambar2)}}" alt="">
								</div>

								<div class="tab_image desc_last">
									<img src="{{asset ($produk->gambar3)}}" alt="">
								</div>
							</div>
						</div>
					</div>
