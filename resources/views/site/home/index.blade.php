        ...
        @if (Auth::check())
            <div class="row">
                <div class="col text-left">
                    <div id="notification"
                        style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: #FFE4C4; color: #333; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
                        <span onclick="closeNotification()"
                            style="position: absolute; top: 10px; right: 10px; cursor: pointer; font-size: 60px;">&times;</span>
                        <h2 style="font-family: 'Arial', sans-serif; margin: 0;">Selamat Datang, {{ Auth::user()->name }}!
                        </h2>
                        <p style="font-size: 16px; margin-top: 10px;">Catatan: Semua fitur Sorting di sini telah diaktifkan,
                            mulai dari penyesuaian berdasarkan kategori, harga, hingga pengurutan berdasarkan abjad.</p>
                    </div>
                ...
                <div class="col">
                    <div class="product-grid" data-isotope='{ "itemSelector": ".product-item", "layoutMode": "fitRows" }'>
                        @foreach ($products as $product)
                            <div class="product-item {{ $product->product_category_id }} mb-4">
                                <div class="product product_filter">
                                    ...
                                    <div class="product_info">
                                        <form action="{{ route('site.wishlist.addToWishlist') }}" method="post">
                                            @csrf
                                        ...
                                        <h6 class="product_name"><a
                                                href="{{ route('site.produk.getIndex', $product->id) }}">{{ $product->name }}</a>
                                        </h6>
